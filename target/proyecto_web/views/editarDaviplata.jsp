    ...
    <c:forEach var="daviplata" items="${daviplata}">
        <form action="daviplata" method="post">
            <h1 class="heading">Actualizar</h1>
                <div class="inputcaja">
                    <input type="hidden" name="idDaviplata" id="idDaviplata" required value="${daviplata.getIdDaviplata()}">
                    <p>${daviplata.getIdDaviplata()}</p></BR>
                </div>
                    <input type="number" name="idUsuario" id="idUsuario" required value="${daviplata.getIdUsuario()}">
                    <label for="idUsuario">Id Usuario</label>
                </div>
                <div class="inputcaja">
                    <input type="number" name="retiro" id="retiro" required value="${daviplata.getRetiro()}">
                    <label for="valorRetiro">Valor del retiro</label>
                </div>
                <div class="inputcaja">
                    <input type="number" name="valorRetiro" id="valorRetiro" required value="${daviplata.getValorRecarga()}">
                    <label for="valorRetiro">Valor de la Recarga</label>
                </div>
                <div class="inputcaja">
                    <input type="number" name="saldoActual" id="saldoActual" required value="${daviplata.getSaldoActual()}">
                    <label for="saldoActual">Saldo Actual</label>
                </div>
                <div class="inputcaja">
                    <input type="checkbox" name="estadoDaviplata" id="estadoDaviplata" value="${daviplata.getEstadoDaviplata()}">
                    <label for="estadoDaviplata">Estado</label>
                </div>
